...
public class TestCase {
	...
	public void testcase() {
		 ...
		 * 
		 * 
		 * public WebElement apply(WebDriver d) { //return
		 * d.findElement(By.className("android.widget.ImageView")); return
		 * d.findElement(By.id(
		 ...
		 */
		// WebElement nokjfs =
		// driver.findElement(By.id("com.hefanlive.news:id/cancel"));
		// nokjfs.click();
		 ...
		 * System.out.println(Xlsfile.readxls("test",4, i)+"  "
		 * +Xlsfile.readxls("test",5, i)+"  "+Xlsfile.readxls("test",6, i)+"  "
		 * +Xlsfile.readxls("test",7, i)); WebElement
		...
		for (int i = 1; i <= 30; i++) {
			...
			/*
			 * System.out.println("for start i=" + i); if
			 * (Xlsfile.isempty("hefanlive_testcase", 1, i)) { i=31; return; }
			 * WebElement elementname = a .element(driver,
			 * Xlsfile.search(Xlsfile.readxls( "hefanlive_testcase", 1, i)));
		...
		/*
		 * WebElement el =
		 * driver.findElement(By.id("com.hefanlive.news:id/iv_logo"));
		 * el.click();
		 */
	...
	public int testcase_step(int i, AppLibs a) {
		...
		WebElement elementname = a.element(driver, Xlsfile.search(Xlsfile.readxls("hefanlive_testcase", 1, i)));
		String execute = Xlsfile.readxls("hefanlive_testcase", 2, i);
		String value = Xlsfile.readxls("hefanlive_testcase", 3, i);
		a.execute(driver, elementname, execute, value);
		return 1;
